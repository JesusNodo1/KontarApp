...
export default function ConteoScreen({ zona, inv, onBack, onZonaFinalizada, user }) {
  ...
  const [manualKb,   setManualKb]   = useState(false) // teclado virtual solo con doble toque
  ...
  // Por default el inputMode es 'none' para evitar que el teclado aparezca con
  // el scanner HW (que emite keystrokes) y robe pantalla al operario.
