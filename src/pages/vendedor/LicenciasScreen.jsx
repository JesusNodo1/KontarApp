...
const V = '#7C3AED'  // color vendedor (violeta)
const VL = '#EDE9FE'

const ROL_LABEL = { admin: 'Admin', contador: 'Contador', vendedor: 'Vendedor' }
const ROL_COLOR = { admin: { bg: '#DBEAFE', c: '#1D4ED8' }, contador: { bg: '#D1FAE5', c: '#059669' }, vendedor: { bg: VL, c: V } }
...
export default function LicenciasScreen() {
  ...
  const [created,   setCreated]   = useState(null) // resultado tras crear
